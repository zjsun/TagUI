...
if ($service_out_count < $service_in_count) {
    ...
    fclose($service_act_file);
    chmod('tagui_service.act', 0700);
}
...
function get_last_service_count($service_file)
{
