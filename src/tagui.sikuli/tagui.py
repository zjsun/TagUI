...
def keyboard_map(input_keys):
    ...
    if input_keys == '[shift]' or input_keys == '[SHIFT]':
        input_keys = u'\ue020'
    elif input_keys == '[ctrl]' or input_keys == '[CTRL]':
        input_keys = u'\ue021'
    elif input_keys == '[alt]' or input_keys == '[ALT]':
        input_keys = u'\ue022'
    elif input_keys == '[meta]' or input_keys == '[META]':
        input_keys = u'\ue023'
    elif input_keys == '[cmd]' or input_keys == '[CMD]':
        input_keys = u'\ue023'
    elif input_keys == '[win]' or input_keys == '[WIN]':
        input_keys = u'\ue042'
...
def type_intent(raw_intent):
    ...
    print
    '[tagui] ACTION - type ' + param1 + ' as ' + param2
...
def select_intent(raw_intent):
    ...
    if using_ocr(param1):
        ...
        ocr_locator = False
    print
    '[tagui] ACTION - click ' + param1
    if ocr_locator:
        if click(text_locator(param1)) == 0:
            return 0
        else:
            print
            '[tagui] ACTION - click ' + param2
...
def snap_intent(raw_intent):
    ...
    print
    '[tagui] ACTION - snap ' + param1 + ' to ' + param2
    if ocr_locator:
        fullscreen_layer = Screen()
        matched_element = text_locator(param1)
        if matched_element == None:
...
while True:
    ...
    try:
        ...
        print
        '[tagui] ERROR  - cannot open tagui.sikuli/tagui_sikuli.in';
        print
        break
    ...
    print
    '[tagui] INPUT  - ' + '[' + tagui_count + '] ' + tagui_intent
    ...
    print
    '[tagui] OUTPUT - ' + '[' + tagui_count + '] ' + intent_result_string;
    print
    tagui_output = open('tagui.sikuli/tagui_sikuli.out', 'w')
